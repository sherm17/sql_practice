...
INSERT INTO Employee
	(EMPLOYEE_ID, FIRST_NAME, LAST_NAME, SALARY, JOINING_DATE, DEPARTMENT,MANAGER_ID) VALUES
		(001, 'James', 'Smith', 100000, to_timestamp('17-02-20 09.00.00', 'YYY-MM-DD HH24:MI:SS'), 'HR', 002),
		(002, 'Jessica', 'Kohl', 80000, to_timestamp('17-06-11 09.00.00', 'YY-MM-DD HH24:MI:SS'), 'Admin', 005),
		(003, 'Alex', 'Garner', 300000, to_timestamp('17-02-20 09.00.00', 'YY-MM-DD HH24:MI:SS'), 'HR', 011),
		(004, 'Pratik', 'Pandey', 500000, to_timestamp('17-02-20 09.00.00', 'YY-MM-DD HH24:MI:SS'), 'Admin', 020),
		(005, 'Christine', 'Robinson', 500000, to_timestamp('17-06-11 09.00.00', 'YY-MM-DD HH24:MI:SS'), 'Admin', 007),
		(006, 'Deepak', 'Gupta', 200000, to_timestamp('17-06-11 09.00.00', 'YY-MM-DD HH24:MI:SS'), 'Account', 015),
		(007, 'Jennifer', 'Paul', 75000, to_timestamp('17-01-20 09.00.00', 'YY-MM-DD HH24:MI:SS'), 'Account', 012),
		(008, 'Deepika', 'Sharma', 90000, to_timestamp('17-04-11 09.00.00', 'YY-MM-DD HH24:MI:SS'), 'Admin', 017);
...
(43744, 18171, '2018-05-24' ,'accepted');
 ...
 (1, 'sam', '2018-01-21', 1::boolean),
 (2, 'phelp', '2018-01-15', 1::boolean),
 (3, 'peyton', '2018-03-12', 1::boolean),
 (4, 'ryan', '2018-02-17', 0::boolean),
 (5, 'james', '2018-01-21', 0::boolean),
 (6, 'christine', '2018-02-27', 1::boolean),
 (7, 'bolt', '2018-02-28', 0::boolean),
 (8, 'jessica', '2018-01-11', 1::boolean),
 (9, 'paul', '2018-04-23', 1::boolean),
 (10, 'brian', '2018-03-12', 0::boolean);
 
 CREATE TABLE sport_accounts(
 sport_player_id integer,
...
count_of_requests_sent integer,
